Feature: Verify the adatin hotel page and booking the hotel
  ...
  Scenario Outline: Verifying the Book A Hotel page and book the hotel with enter all fields
    ...
    Then User should verfied the login page sucess message "Select Hotel "
    ...
    Examples: 
      | Username     | password    | location | hotels         | roomtype | noofrooms | checkindate | checkoutdate | adultsperroom | childerperroom | First Name | Last Name   | Billing Address |
      | venkatraj027 | harinathraj | Brisbane | Hotel Sunshine | Double   | 4 - Four  | 17/11/2022  | 18//11/2022  | 3 - Three     | 4 - Four       | prabhakara | subramanian | karapakam       |
  ...
  Scenario Outline: Verifying the Book A Hotel page without enter any fields and click book button
    ...
    Then User should verfied the book a hotel page with error message "Please Enter your First Name"," Please Enter you Last Name","Please Enter your Address","Use 16 digit Dummy Data Please Enter your 16 Digit Credit Card Number","Please Select your Credit Card Type"," Please Select your Credit Card Expiry Month"and "  Please Enter your Credit Card CVV Number"
